...
final class GlanceSettings {
    ...
    private enum Key {
        ...
        /// Which embedding space `matchThreshold` was set for; see `ArcFaceEmbedder.defaultThreshold`.
    ...
    var matchThreshold: Float {
        didSet {
            ...
            defaults.set(ArcFaceEmbedder.currentModelIdentifier, forKey: Key.matchThresholdModel)
        }
    }
    ...
    private init() {
        ...
        if storedThresholdModel == ArcFaceEmbedder.currentModelIdentifier,
